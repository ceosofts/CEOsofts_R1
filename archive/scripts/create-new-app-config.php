...
/**
 * สคริปต์สร้างไฟล์ config/app.php ใหม่
 * เพื่อแก้ไขปัญหา Cipher ที่ไม่รองรับ
 */

echo "Create New App Config File\n";
echo "=========================\n\n";

// สร้างโฟลเดอร์ backups ถ้ายังไม่มี
if (!is_dir(__DIR__ . '/backups')) {
    mkdir(__DIR__ . '/backups');
    echo "✅ สร้างโฟลเดอร์ backups เรียบร้อยแล้ว\n";
}

// สำรองไฟล์ config/app.php เดิม
$appConfigPath = __DIR__ . '/config/app.php';
if (file_exists($appConfigPath)) {
    $timestamp = date('Y-m-d_H-i-s');
    copy($appConfigPath, __DIR__ . "/backups/app.php.{$timestamp}");
    echo "✅ สำรองไฟล์ config/app.php ไว้ที่ backups/app.php.{$timestamp}\n";
}
...
// บันทึกไฟล์ config/app.php ใหม่
...
echo "\nเสร็จสิ้น! ไฟล์ config/app.php ถูกสร้างใหม่พร้อมค่า cipher ที่ถูกต้อง\n";
