        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('customers.store') }}" method="POST" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="type" id="type" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                            <option value="company" {{ old('type') == 'company' ? 'selected' : '' }}>บริษัท/องค์กร</option>
                                            <option value="person" {{ old('type') == 'person' ? 'selected' : '' }}>บุคคลธรรมดา</option>
                                        </select>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="reference_id" id="reference_id" value="{{ old('reference_id') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_supplier" id="is_supplier" value="1" {{ old('is_supplier') ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="note" id="note" rows="3" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">{{ old('note') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-4">
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300">โทรศัพท์</label>
                                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="website" class="block text-sm font-medium text-gray-700 dark:text-gray-300">เว็บไซต์</label>
                                        <input type="url" name="website" id="website" value="{{ old('website') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <div class="grid grid-cols-5 gap-2">
                                                ...
                                                <input type="text" name="social_media[facebook]" value="{{ old('social_media.facebook') }}" class="col-span-4 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                            </div>
                                            <div class="grid grid-cols-5 gap-2">
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 col-span-1">Line</label>
                                                <input type="text" name="social_media[line]" value="{{ old('social_media.line') }}" class="col-span-4 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                            </div>
                                            <div class="grid grid-cols-5 gap-2">
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 col-span-1">Instagram</label>
                                                <input type="text" name="social_media[instagram]" value="{{ old('social_media.instagram') }}" class="col-span-4 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <label for="last_contacted_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">วันที่ติดต่อล่าสุด</label>
                                        <input type="date" name="last_contacted_date" id="last_contacted_date" value="{{ old('last_contacted_date') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-4">
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="contact_person" id="contact_person" value="{{ old('contact_person') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="contact_person_position" class="block text-sm font-medium text-gray-700 dark:text-gray-300">ตำแหน่ง</label>
                                        <input type="text" name="contact_person_position" id="contact_person_position" value="{{ old('contact_person_position') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="contact_person_email" class="block text-sm font-medium text-gray-700 dark:text-gray-300">อีเมล</label>
                                        <input type="email" name="contact_person_email" id="contact_person_email" value="{{ old('contact_person_email') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="contact_person_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300">เบอร์โทรศัพท์</label>
                                        <input type="text" name="contact_person_phone" id="contact_person_phone" value="{{ old('contact_person_phone') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="contact_person_line_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">LINE ID</label>
                                        <input type="text" name="contact_person_line_id" id="contact_person_line_id" value="{{ old('contact_person_line_id') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-4">
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <select name="customer_group" id="customer_group" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                            <option value="">-- เลือกกลุ่มลูกค้า --</option>
                                            <option value="A" {{ old('customer_group') == 'A' ? 'selected' : '' }}>กลุ่ม A (VIP)</option>
                                            <option value="B" {{ old('customer_group') == 'B' ? 'selected' : '' }}>กลุ่ม B (ลูกค้าประจำ)</option>
                                            <option value="C" {{ old('customer_group') == 'C' ? 'selected' : '' }}>กลุ่ม C (ลูกค้าทั่วไป)</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="customer_rating" id="customer_rating" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                            ...
                                            @for($i = 1; $i <= 5; $i++)
                                                <option value="{{ $i }}" {{ old('customer_rating') == $i ? 'selected' : '' }}>{{ $i }} ดาว</option>
                                            @endfor
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="metadata[industry]" id="industry" value="{{ old('metadata.industry') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="sales_region" class="block text-sm font-medium text-gray-700 dark:text-gray-300">พื้นที่การขาย</label>
                                        <input type="text" name="metadata[sales_region]" id="sales_region" value="{{ old('metadata.sales_region') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        ...
                                        <select name="payment_term_type" id="payment_term_type" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                            <option value="credit" {{ old('payment_term_type') == 'credit' ? 'selected' : '' }}>เครดิต</option>
                                            <option value="cash" {{ old('payment_term_type') == 'cash' ? 'selected' : '' }}>เงินสด</option>
                                            <option value="cheque" {{ old('payment_term_type') == 'cheque' ? 'selected' : '' }}>เช็ค</option>
                                            <option value="transfer" {{ old('payment_term_type') == 'transfer' ? 'selected' : '' }}>โอนเงิน</option>
                                        </select>
                                    </div>
                                    <div>
                                        <label for="credit_limit" class="block text-sm font-medium text-gray-700 dark:text-gray-300">วงเงินเครดิต (บาท)</label>
                                        <input type="number" step="0.01" min="0" name="credit_limit" id="credit_limit" value="{{ old('credit_limit') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="credit_term" class="block text-sm font-medium text-gray-700 dark:text-gray-300">ระยะเวลาเครดิต (วัน)</label>
                                        <input type="number" min="0" name="metadata[credit_term]" id="credit_term" value="{{ old('metadata.credit_term') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="discount_rate" class="block text-sm font-medium text-gray-700 dark:text-gray-300">อัตราส่วนลดพิเศษ (%)</label>
                                        <input type="number" step="0.01" min="0" max="100" name="discount_rate" id="discount_rate" value="{{ old('discount_rate') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-4">
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="bank_branch" class="block text-sm font-medium text-gray-700 dark:text-gray-300">สาขา</label>
                                        <input type="text" name="bank_branch" id="bank_branch" value="{{ old('bank_branch') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="bank_account_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">ชื่อบัญชี</label>
                                        <input type="text" name="bank_account_name" id="bank_account_name" value="{{ old('bank_account_name') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                    <div>
                                        <label for="bank_account_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300">เลขที่บัญชี</label>
                                        <input type="text" name="bank_account_number" id="bank_account_number" value="{{ old('bank_account_number') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('customers.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:border-gray-600">
                        ยกเลิก
                    </a>
