        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <form method="POST" action="{{ route('branch-offices.store') }}">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code" id="code" value="{{ old('code', $nextBranchCode ?? '') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    <p class="mt-1 text-sm text-gray-500">รหัสสาขาจะถูกสร้างอัตโนมัติหากไม่ระบุ</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="address" id="address" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>{{ old('address') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="manager_id" name="manager_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                        ...
                                        @foreach($managers as $manager)
                                            <option value="{{ $manager->id }}" data-company-id="{{ $manager->company_id }}" {{ old('manager_id') == $manager->id ? 'selected' : '' }}>
                                ...
                                <div class="flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0">
                                    <div class="flex items-center">
                                        <input type="checkbox" id="is_headquarters" name="is_headquarters" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600" {{ old('is_headquarters') ? 'checked' : '' }}>
                                        <label for="is_headquarters" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">เป็นสำนักงานใหญ่</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="checkbox" id="is_active" name="is_active" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600" {{ old('is_active', true) ? 'checked' : '' }}>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="tax_branch_id" id="tax_branch_id" value="{{ old('tax_branch_id') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        placeholder="00000">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="opening_date" id="opening_date" value="{{ old('opening_date') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>

                                <!-- เพิ่มข้อมูล metadata อื่นๆ -->
                                <div class="border border-gray-200 dark:border-gray-600 rounded-md p-4 bg-gray-50 dark:bg-gray-700">
                                    <h4 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-3">ข้อมูล metadata เพิ่มเติม</h4>
                                    
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label for="additional_metadata_key" class="block text-sm font-medium text-gray-700 dark:text-gray-300">คีย์</label>
                                            <input type="text" name="additional_metadata_key" id="additional_metadata_key" value="{{ old('additional_metadata_key') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                                placeholder="เช่น contact_person">
                                        </div>
                                        <div>
                                            <label for="additional_metadata_value" class="block text-sm font-medium text-gray-700 dark:text-gray-300">ค่า</label>
                                            <input type="text" name="additional_metadata_value" id="additional_metadata_value" value="{{ old('additional_metadata_value') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
